...
@section('content')
       <section class="hero-slider hero-style-1">
                ...
                <div class="hero-inner">
                    <div class="container">
                        ...
                        <div data-swiper-parallax="500" class="slide-btns">
                            <a href="https://seoul-html.itech-theme.com/index.html#" class="theme-btn">More About Us</a> 
                            <a href="https://www.youtube.com/embed/7e90gBu4pas?autoplay=1" class="video-btn video-btn-s1" data-type="iframe" tabindex="0"> Watch Video<i class="fi flaticon-play-button"></i></a>
                        </div>
        ...
        <section class="tips-tricks-section section-padding">
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    <div class="col col-md-6">
                        <div class="img-holder">
                            <img src="" alt="">tips.png
                        </div>
                    </div>
                    <div class="col col-md-6">
                        <div class="tips-trick-grids">
                            <div class="grid">
                                <div class="icon">
                                    <img src="./index_files/check.png" alt="">
                                </div>
        ...
        <section class="why-choose-us-s1 section-padding">
            <div class="container">
                <div class="row">
                    <div class="col col-md-6">
                        <div class="section-title">
                    ...
                    <div class="col col-md-6">
                        <div class="img-holder">
                            <img src="./index_files/why-choose-us-vec.png" alt="">
                        </div>
                    </div>
                </div>
            </div> <!-- end container -->
        ...
        <section class="seo-rank-section">
            <div class="container">
                <div class="row">
                ...
                <div class="rocket">
                    <img src="./index_files/rocket-2.png" alt="">
                </div>
            </div> <!-- end container -->
        </section>
        ...
        <section class="testimonials-section">
            <div class="container">
                <div class="row">
                    <div class="col col-md-6">
                        <img src="./index_files/group-img.png" alt="">
                    </div>
